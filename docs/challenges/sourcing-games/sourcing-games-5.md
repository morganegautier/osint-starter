---
title: "Mastering Sourcing Games 5: advanced techniques from SourceCon 2017"
description: Unlock the secrets to mastering Sourcing Games 5 with advanced techniques and solutions inspired by SourceCon 2017. Learn how to tackle complex sourcing challenges effectively.
...
Gary Vaynerchuk's first tweet was on May 4, 2007.

![Solution to game 02](/img/challenges/sourcing-games/game-5/sourcing-games-5-02.png "Solution to game 02")

The password to reach the next level is "**2321**".
...
![Solution to game 03](/img/challenges/sourcing-games/game-5/sourcing-games-5-03.png "Solution to game 03")

The password to reach the next level is "**corprecruiter**".
...
The aim of Game 04 is to find the name of a person, given some information. Here we have 3 useful pieces of information about the person:
...
Jessica Carmona lives in the province of Quebec in Canada and worked as Strategic Planner Coordinator for the company Midiaweb from August 2012 to October 2013.

![Solution to game 04](/img/challenges/sourcing-games/game-5/sourcing-games-5-04-2.png "Solution to game 04")

The password to reach the next level is "**carmona**".
...
Greg Meyers' profile fits the description since he has been working as a Corporate VP and Chief Information Officer (CIO) for Motorola Solutions until 2018 and then worked for another company based in Basel until 2022.

![Solution to game 05](/img/challenges/sourcing-games/game-5/sourcing-games-5-05-1.png "Solution to game 05")

Greg Meyers' Twitter description confirms that he is a CIO.

![Solution to game 05](/img/challenges/sourcing-games/game-5/sourcing-games-5-05-2.png "Solution to game 05")

The password to reach the next level is "**meyers**".
...
Sally Young fits perfectly the description given:

![Solution to game 06](/img/challenges/sourcing-games/game-5/sourcing-games-5-06-2.png "Solution to game 06")

The password to reach the next level is "**justafish**".
